...
class NetGAN:
    ...
    def __init__(self, N, rw_len, 
                ...
                dir_name="fuck", every_temperature=2000):
        """
        Initialize NetGAN.
        ...
        every_temperature: int, default: 2000
                            every 2000 iterations with a multiplicative decay
        seed: int, default: 15
              Random seed.
        ...
        self.params = {
            ...
            'every_temperature': every_temperature,
    ...
    def train(self, A_orig, val_ones, val_zeros,  max_iters=50000, stopping=None, eval_transitions=15e6,
        ...
        for _it in range(max_iters):
            ...
            if _it > 500 and _it % 50 == 0:
                ...
                downsize_200_ratio_num_of_extra_edge = 1
                print("200 FD graph number of extra edges: ", downsize_200_ratio_num_of_extra_edge)
                # downsize_200_ratio_cd_val, _ = newman_partition(_graph, label, _graph.shape[0])
                downsize_200_ratio_cd_val = 1
                ...
                downsize_150_ratio_num_of_extra_edge = 1
                print("150 FD graph number of extra edges: ", downsize_150_ratio_num_of_extra_edge)
                # downsize_150_ratio_cd_val, _ = newman_partition(_graph, label, _graph.shape[0])
                downsize_150_ratio_cd_val = 1
                ...
                downsize_120_ratio_num_of_extra_edge = 1
                print("120 FD graph number of extra edges: ", downsize_120_ratio_num_of_extra_edge)
                # downsize_120_ratio_cd_val, _ = newman_partition(_graph, label, _graph.shape[0])
                downsize_120_ratio_cd_val = 1
            ...
            if _it > 0 and _it % self.params['every_temperature'] == 0:
